	      	...
	      	if (retorno == SUCESSO_CADASTRO){ 
	      		...
	      		switch(retorno){
	      			case ERRO_CADASTRO_MATRICULA:{
	      				printf("Matricula Invalida. Deve ser maior que 0.\n");
	      				break;
	      			}
	      			case ERRO_CADASTRO_SEXO:{
	      				printf("Sexo Invalido. Digite 'm' ou 'M' para Masculino ou 'f' ou 'F' para Feminino.\n");
	      				break;
	      			}
	      ...
	      case 2: {
	      	...
	      	if (retorno == SUCESSO_EXCLUSAO){ 
	      		...
	      		switch(retorno){
	      			...
	      			case NAO_ENCONTRADO:{
	      				printf("Nao foi encontrado o aluno com a matricula digitada.\n");
	      				break;
	      			}
	      			default:{
	      				printf("Erro desconhecido.\n");
